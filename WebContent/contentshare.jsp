		...
		<div class="container">
			<div class="row">
				<div class="col-xs-4 col-xs-offset-3">
					...
					<div class="col-xs-3">
						<a href="contentresale.html">轉售</a>
					</div>
					<div class="col-xs-3">
				...
				<div class="col-xs-3 page">
					<a href=""><</a><span>5/50</span><a href="">></a>
				</div>
			</div>
			<div class="mainpart row">
				...
				<c:forEach var="vo" items="${productVOs}">
					...
					<div class="col-xs-3">
						<a href="http://localhost:8080/srdtest/ProductServlet?action=getOneProduct&idproduct=${vo.getIdproduct()}"><img src="${vo.getPicture1()}"></a>
					</div>
					<div class="col-xs-9">
						<a href="http://localhost:8080/srdtest/ProductServlet?action=getOneProduct&idproduct=${vo.getIdproduct()}"><p>${vo.getName()}</p></a>
						<div>
