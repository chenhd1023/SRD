            ...
            <div class="person col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div id="information" class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div id="informationblock">
                        <a href="MessageServlet?action=getLatestConversation&accountid=${accountid}"><p style="color:black">訊息</p></a>
                        <a href="CommentServlet?action=commentdone&accountid=${accountid}"><p style="color:black">借物/評論紀錄</p></a>
                        <a href="CommentServlet?action=commentyet&accountid=${accountid}"><p style="color:black">尚未評論</p></a>
                    </div>
                </div>
            </div>
        </div>
