...
<link href="css/contentresaleCss.css" rel="stylesheet" type="text/css">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-4 col-xs-offset-3">
					<div class="col-xs-3">
						<img src="img/content/resale.svg" width="100%">
					</div>
					<div class="col-xs-3">
				...
				<div class="catalog col-xs-3 col-sm-3 col-md-3 col-lg-3">
					...
					<div class="puzzleicon">
						...
						<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
							<a class="kind" href="ProductServlet?action=catalogSearch&contentType=contentresale&catalog=lodging"
					...
					<div class="puzzleicon">
						...
						<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
							<a class="kind" href="ProductServlet?action=catalogSearch&contentType=contentresale&catalog=exam"
					...
					<div class="puzzleicon">
						...
						<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
							<a class="kind" href="ProductServlet?action=catalogSearch&contentType=contentresale&catalog=3C"
					...
					<div class="puzzleicon">
						...
						<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
							<a class="kind" href="ProductServlet?action=catalogSearch&contentType=contentresale&catalog=travel"
					...
					<div class="puzzleicon">
						...
						<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
							<a class="kind" href="ProductServlet?action=catalogSearch&contentType=contentresale&catalog=book"
					...
					<div class="puzzleicon">
						...
						<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
							<a class="kind" href="ProductServlet?action=catalogSearch&contentType=contentresale&catalog=cloth"
					...
					<div class="puzzleicon">
						...
						<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
							<a class="kind" href="ProductServlet?action=catalogSearch&contentType=contentresale&catalog=fun"
