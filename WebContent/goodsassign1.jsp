	...
	<body>
		...
		<p>&nbsp</p>
			...
			<div class="row table col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<form class="form-horizontal" role="form" name="form1" id="form1" action="ProductServlet"  method="post">
					...
					<div class="form-group">
						<label class="col-xs-2 col-sm-2 col-md-2 col-lg-2 control-label">面交地點</label>
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
							<input type="text" class="form-control" id="place" name="place"  placeholder="面交地點">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
							<input type="text" class="form-control" id="pwd1" name="describe"  placeholder="物品狀況">
						</div>
					</div>
